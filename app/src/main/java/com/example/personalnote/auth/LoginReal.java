...
public class LoginReal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mEmail.isEmpty() || mPassword.isEmpty()){
                    Toast.makeText(LoginReal.this, "Fields Are Required.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                fAuth.signInWithEmailAndPassword(mEmail,mPassword).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        Toast.makeText(LoginReal.this, "Success !", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(LoginReal.this, "Login Failed. " + e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        createAcc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(),RegisterReal.class);
                startActivity(i);
            }
        });
